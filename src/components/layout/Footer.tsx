...
const DEFAULT_FOOTER = {
  logoText: 'TechFlow',
  companyDescription:
    'Empowering businesses with cutting-edge automation tools and AI-driven analytics. Trusted by over 10,000 companies worldwide to streamline operations and accelerate growth.',
  ...
  newsletterDisclaimer:
    'Weekly insights on automation trends and product updates. Unsubscribe anytime.',
  ...
  const footerSections = [
    {
      ...
      links: [
        { name: 'Automation Hub', href: '/automation', editableId: 'link-footer-automation' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Live Webinars', href: '/webinars', editableId: 'link-footer-webinars' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'SOC 2 Compliance', href: '/compliance', editableId: 'link-footer-compliance' },
      ],
    },
  ];
