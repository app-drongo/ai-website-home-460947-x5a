...
const DEFAULT_PAGEHEADER = {
  title: 'About Home',
  description:
    "Discover how we're transforming the way people find, buy, and sell homes with innovative technology and personalized service.",
  ...
  stat2Value: '18K+',
  stat3Label: 'Average Days on Market',
  stat3Value: '12',
