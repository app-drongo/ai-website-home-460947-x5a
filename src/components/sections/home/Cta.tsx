...
const DEFAULT_CTA = {
  badge: 'Transform Your Home Today',
  mainTitle: 'Ready to Create Your',
  mainTitleHighlight: 'Dream Home?',
  description:
    'Join thousands of homeowners who have transformed their living spaces with our expert guidance and premium home solutions. Start your home improvement journey today.',
  primaryCTA: 'Get Started Now',
  primaryCTAHref: '/contact',
  secondaryCTA: 'View Pricing',
  secondaryCTAHref: '/pricing',
  trustText: 'Trusted by homeowners nationwide',
  stat1Value: '15K+',
  stat1Label: 'Homes Transformed',
  stat2Value: '98%',
  ...
  feature1Title: 'Free Consultation',
  feature1Description: 'Expert advice at no cost to get you started',
  feature2Title: 'Quality Guaranteed',
  feature2Description: 'Premium materials and workmanship warranty',
  feature3Title: 'Quick Turnaround',
  feature3Description: 'Most projects completed within 2-4 weeks',
} as const;
...
export default function Cta(props: CTAProps) {
  ...
  const stats = [
    { value: config.stat1Value, label: config.stat1Label, icon: Home },
    { value: config.stat2Value, label: config.stat2Label, icon: CheckCircle },
    { value: config.stat3Value, label: config.stat3Label, icon: Shield },
    { value: config.stat4Value, label: config.stat4Label, icon: Star },
  ];
  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-1/4 size-96 bg-muted/30 rounded-full blur-3xl opacity-20" />
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="text-base px-8 py-4 border-muted-foreground/30 hover:bg-muted/50"
