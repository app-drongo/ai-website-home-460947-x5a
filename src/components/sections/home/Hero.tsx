...
const DEFAULT_HERO = {
  ...
  imageAlt: 'Modern smart home interior with automated lighting',
  statsLabel1: 'Energy Savings',
  statsValue1: 'Up to 30%',
  statsLabel2: 'Setup Time',
  statsValue2: 'Under 2 hours',
} as const;
