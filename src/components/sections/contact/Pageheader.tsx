...
const DEFAULT_PAGEHEADER = {
  title: 'Get In Touch',
  description:
    'Ready to transform your home with smart automation? Our experts are here to help you create the perfect connected living experience.',
  ...
  stat2Value: '98%',
  stat3Label: 'Average Setup Time',
  stat3Value: '2 Hours',
  stat4Label: 'Energy Savings',
  stat4Value: '30%',
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          {config.showStats && (
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-12 mt-12 border-t border-muted">
              <div>
                <div className="text-3xl font-bold text-primary" data-editable="stat1Value">
                  {config.stat1Value}
                </div>
              ...
              <div>
                <div className="text-3xl font-bold text-primary" data-editable="stat2Value">
                  {config.stat2Value}
                </div>
              ...
              <div>
                <div className="text-3xl font-bold text-primary" data-editable="stat3Value">
                  {config.stat3Value}
                </div>
              ...
              <div>
                <div className="text-3xl font-bold text-primary" data-editable="stat4Value">
                  {config.stat4Value}
                </div>
