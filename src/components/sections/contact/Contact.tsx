...
const DEFAULT_CONTACT = {
  badge: 'Get In Touch',
  mainTitle: 'Transform Your Home',
  mainTitleHighlight: 'Today',
  mainDescription:
    'Ready to upgrade your home with smart automation? Our experts are here to help you create the perfect smart home solution. Get your free consultation and join 15,000+ satisfied homeowners.',
  formTitle: 'Get Your Free Consultation',
  formDescription:
    "Tell us about your home and we'll provide a custom smart home solution within 24 hours.",
  submitButton: 'Get Free Quote',
  contactSectionTitle: 'Contact Our Experts',
  method1Title: 'Email Support',
  method1Description: 'Get detailed information',
  method1Contact: 'hello@smarthome.com',
  method2Title: 'Call Today',
  method2Description: 'Speak with our specialists',
  method2Contact: '+1 (555) HOME-TECH',
  method3Title: 'Live Chat',
  method3Description: 'Instant support available',
  method3Contact: 'Available 9 AM - 8 PM',
  officesSectionTitle: 'Service Areas',
  office1City: 'Metro Area',
  office1Address: 'Serving all major metropolitan areas',
  office1Timezone: 'Same-day service',
  office2City: 'Suburban',
  office2Address: 'Complete suburban home coverage',
  office2Timezone: '2-hour setup',
  office3City: 'Rural',
  office3Address: 'Extended service to rural properties',
  office3Timezone: 'Custom solutions',
  ...
  supportNote: 'Emergency support available 24/7 for existing customers',
  nameLabel: 'Full Name *',
  namePlaceholder: 'Enter your full name',
  emailLabel: 'Email Address *',
  emailPlaceholder: 'your.email@example.com',
  companyLabel: 'Property Type',
  companyPlaceholder: 'Single family, Condo, Apartment, etc.',
  messageLabel: 'Tell Us About Your Project *',
  messagePlaceholder:
    "Describe your smart home goals, current setup, and any specific features you're interested in...",
} as const;
